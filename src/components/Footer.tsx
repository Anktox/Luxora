export function Footer() {
  return (
    <footer className="relative px-5 pb-10 pt-4 md:px-10">
      <div className="glass-lite mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 rounded-[1.6rem] px-6 py-8 md:flex-row md:items-center md:px-8">
        <div>
