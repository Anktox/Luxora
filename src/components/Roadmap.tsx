...
export function Roadmap() {
  return (
    <section id="roadmap" className="content-auto relative px-5 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative">
          <div className="absolute bottom-0 left-[1.15rem] top-2 w-px bg-gradient-to-b from-gold via-royal-soft to-gold md:left-1/2 md:-translate-x-px" />
              ...
              return (
                ...
                >
                  <div className={`${left ? 'md:text-right' : ''} pl-12 md:pl-0`}>
                    <div className="glass-lite inline-block rounded-[1.5rem] p-5 text-left md:p-6">
                  ...
                  <div className="pointer-events-none absolute left-2 top-6 h-5 w-5 rounded-full border-2 border-gold bg-cream md:left-1/2 md:-translate-x-1/2" />
